module.exports = {
  "updated_at": "2026-07-31 06:13",
  "update_session": "morning",
  "timezone": "Asia/Shanghai",
  "source": "futures-oil-daily 最新快照：source_runs/2026-07-31-daily/raw/futures_market_data.json；国内合约名单先由 contract_selector_skill 选择，再由 contract_discovery_skill 按当月实时成交量、持仓量、成交额排序生成，海外产地盘展示马来 BMD FCPO 与印尼 ICDX CPOTR；内盘具体合约与日线缺口由 AkShare 补充，并用同花顺问财行情skill交叉验证",
  "fundamental_mode": "refresh",
  "fundamental_updated_at": "2026-07-31 06:13",
  ...
  "market_references": {
    "malaysia_fcpo": {
      ...
      "change": "-0.47%",
      "unit": "林吉特/吨",
      "updated_at": "2026-07-29T22:59:58",
  ...
  "contracts": [
    {
      ...
      "view": "棕榈油当前观点为分歧震荡，置信度低。核心原因是：各类信号并不一致，暂按分歧震荡处理；技术面显示震荡，主要信号为价格在20日均线上方、均线结构震荡。基本面背景看棕榈油库存偏高，非24小时新增，只作背景；豆棕价差用于相对强弱背景；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅-0.24%；成交量较前快照-7.58%；持仓较前快照-3.89%。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 146.86，说明观察位需要给盘中噪音留出空间。综合评分 49.70 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
          "title": "外盘联动",
          "text": "P的外盘弹性主要来自FCPO（-0.47%），CBOT豆油（+0.51%）决定油脂板块共振强度。两者同向时，内盘更容易形成顺畅传导；若背离，盘面通常更偏震荡。"
        },
        {
          "title": "库存与价差",
          "text": "国内背景看两点：棕榈油库存 83.91，豆棕价差 -970。库存偏高会限制单边上行弹性，价差变化则决定P相对Y/OI是继续强，还是转为板块跟随。"
        },
        {
          "title": "评分解释",
      ...
      "strategy_recommendation": {
        "stance": "分歧震荡",
        "entry": "现价 9370；区间内等待驱动与资金确认",
        "take_profit": "上方观察位 9684.00 / 下方观察位 9023.72",
        "stop_loss": "下方观察位 9023.72",
        "upper_watch": "9684.00",
        "lower_watch": "9023.72",
    ...
    },
    {
      ...
      "view": "棕榈油当前观点为分歧震荡，置信度低。核心原因是：各类信号并不一致，暂按分歧震荡处理；技术面显示震荡，主要信号为价格在20日均线上方、均线结构震荡。基本面背景看棕榈油库存偏高，非24小时新增，只作背景；豆棕价差用于相对强弱背景；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅-0.17%；成交量较前快照-75.59%；持仓较前快照-23.49%。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 134.21，说明观察位需要给盘中噪音留出空间。综合评分 50.10 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        "stance": "分歧震荡",
        "entry": "现价 9644；区间内等待驱动与资金确认",
        "take_profit": "上方观察位 9935.51 / 下方观察位 9324.88",
        "stop_loss": "下方观察位 9324.88",
        "upper_watch": "9935.51",
        "lower_watch": "9324.88",
        "invalidation": "若价格突破区间且驱动/资金同向，震荡判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
    ...
    },
    {
      ...
      "view": "豆油当前观点为分歧震荡，置信度低。核心原因是：各类信号并不一致，暂按分歧震荡处理；技术面显示偏空，主要信号为价格在20日均线下方、短均线转弱。基本面背景看豆油库存压力，非24小时新增，只作背景；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅-0.08%；成交量较前快照-10.27%；持仓较前快照-7.08%。需要降级看待的地方：技术面偏空，但资金与盘面偏多，当前不宜仅按技术面给出偏空结论。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 87.71，说明观察位需要给盘中噪音留出空间。综合评分 47.40 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
          "title": "外盘联动",
          "text": "Y首先锚定CBOT豆油（+0.51%），同时受FCPO（-0.47%）影响油脂整体风险偏好。如果CBOT强而FCPO弱，Y可能强于P，但板块趋势会更不顺。"
        },
        {
          "title": "库存与价差",
          "text": "国内背景看豆油库存 138.88 和豆棕价差 -970。库存偏高时，Y独立上攻需要更强外盘或资金配合；价差变化会影响它对P的拖累或托底。"
        },
        {
          "title": "评分解释",
      ...
      "strategy_recommendation": {
        "stance": "分歧震荡",
        "entry": "现价 8400；区间内等待驱动与资金确认",
        "take_profit": "上方观察位 8707.17 / 下方观察位 8328.64",
        "stop_loss": "下方观察位 8328.64",
        "upper_watch": "8707.17",
        "lower_watch": "8328.64",
        "invalidation": "若价格突破区间且驱动/资金同向，震荡判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
    ...
    },
    {
      ...
      "source": "AkShare + 同花顺问财行情skill",
      "note": "Y 用于观察豆系对棕榈油的共振或拖累。",
      "verification": "价格一致：AkShare 8420 / 行情skill 8420",
      "score": {
        "total": 45.7,
        "technical": 29.0,
        "fundamental": 50.0,
      ...
      "view": "豆油当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏空，主要信号为价格在20日均线下方、短均线转弱。基本面背景看豆油库存压力，非24小时新增，只作背景；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅-0.19%；成交量较前快照-53.29%；持仓较前快照+2.23%。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 80.64，说明观察位需要给盘中噪音留出空间。综合评分 45.70 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "菜油当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示震荡，主要信号为价格在20日均线下方、均线结构震荡。基本面背景看菜油库存压力，非24小时新增，只作背景；菜油基本面更多看油脂内部轮动；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅-0.14%；成交量较前快照-40.36%；持仓较前快照-6.33%。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 144.43，说明观察位需要给盘中噪音留出空间。综合评分 50.20 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
          "title": "外盘联动",
          "text": "OI没有单一外盘锚，更多看CBOT豆油（+0.51%）和FCPO（-0.47%）共同带来的板块方向。外盘共振越强，菜油相对强弱切换越容易被资金放大。"
        },
        {
          "title": "库存与价差",
          "text": "菜油库存 49.93，豆棕价差 -970。OI更容易体现油脂内部轮动，若库存压力没有缓解，单独走强的持续性需要打折。"
        },
        {
          "title": "评分解释",
    ...
    },
    {
      ...
      "view": "菜油当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏空，主要信号为价格在20日均线下方、均线结构震荡。基本面背景看菜油库存压力，非24小时新增，只作背景；菜油基本面更多看油脂内部轮动；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅-0.03%；成交量较前快照-87.72%；持仓较前快照-58.39%。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 137.64，说明观察位需要给盘中噪音留出空间。综合评分 47 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "豆粕当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示震荡，主要信号为价格在20日均线下方、均线结构震荡、区间波动收敛，等待方向确认。基本面背景看基本面暂无强新增驱动；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅+0.03%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 48.21，说明观察位需要给盘中噪音留出空间。综合评分 50.60 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
          "title": "外盘联动",
          "text": "外盘涨跌幅主要用于观察情绪传导：FCPO -0.47%，CBOT豆油 +0.51%。"
        },
        {
          "title": "库存与价差",
    ...
    },
    {
      ...
      "technical_detail": [
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 42.86，说明观察位需要给盘中噪音留出空间。综合评分 50.50 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "菜粕当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏空，主要信号为价格在20日均线下方、均线结构震荡。基本面背景看基本面暂无强新增驱动；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅+0.44%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 50，说明观察位需要给盘中噪音留出空间。综合评分 47.40 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "菜粕当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏空，主要信号为价格在20日均线下方、均线结构震荡。基本面背景看基本面暂无强新增驱动；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅-0.13%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 39.71，说明观察位需要给盘中噪音留出空间。综合评分 46.90 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "马棕油当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏空，主要信号为外盘参考合约，技术历史样本不足。基本面背景看外盘参考合约，国内基本面因子不直接套用；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅-0.47%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
          "text": "现价 4653 先看与 MA20 需进一步核验、MA60 需进一步核验 的相对位置，技术评分 需进一步核验，读数为数据需进一步核验。价格对均线支撑的依赖减弱，下方区间有效性需要继续观察；主要信号是：外盘参考合约，技术历史样本不足。"
        },
        {
          "title": "关键区间",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 39，说明观察位需要给盘中噪音留出空间。综合评分 48.90 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        ...
        "take_profit": "上方观察位 4737.71 / 下方观察位 4568.29",
        "stop_loss": "下方观察位 4568.29",
        "upper_watch": "4737.71",
        "lower_watch": "4568.29",
        "invalidation": "若价格突破区间且驱动/资金同向，震荡判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
    ...
    },
    {
      ...
      "view": "印尼棕榈油当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示震荡，主要信号为外盘参考合约，技术历史样本不足。基本面背景看外盘参考合约，国内基本面因子不直接套用；驱动看FCPO-0.47%（非24小时新增，降权）；CBOT豆油+0.51%（24小时新增）；美豆+0.89%（24小时新增）；资金看当日涨跌幅0.00%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 163，说明观察位需要给盘中噪音留出空间。综合评分 50.80 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
