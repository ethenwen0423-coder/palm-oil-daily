(function () {
  const groups = [
    ...
    },
    {
      id: "airbag",
      name: "气囊宝",
      description: "1.0按到期结果结算，2.0（气囊累计）按日观察、逐笔结算；两者都以相对保护区间换取敲入后转远期的义务。",
      items: [
        {
          name: "正向气囊宝1.0",
          type: "正向安全气囊",
        ...
        },
        {
          ...
          type: "每日结算正向气囊",
          badge: "采购防涨",
          bestFor: "每日采购、空单分批止盈或累沽风险对冲，希望逐日匹配上涨敞口。",
          mechanism: "每日收盘高于未敲入执行价时按参与率结算上涨收益；落在下方相对保护区间内时，当日无损益。",
          trigger: "收盘触及下方障碍后，支付此前累计收益，剩余观察数量按敲入参与率转为多头远期。",
          tradeoff: "已结算头寸可逐日释放保证金，但敲入会集中形成剩余多头；保护区内提前终止也可能亏损。",
        },
        {
          name: "反向气囊累计2.0",
          type: "每日结算反向气囊",
          badge: "库存防跌",
          bestFor: "每日轮库销售或持有库存，希望逐日取得下跌补偿，又不想用期货空单压制小幅上涨收益。",
          mechanism: "每日收盘低于未敲入执行价时按参与率结算下跌收益；落在上方相对保护区间内时，当日无损益。",
          trigger: "收盘触及上方障碍后，支付此前累计收益，剩余观察数量按敲入参与率转为空头远期。",
          tradeoff: "适合匹配真实销售流量，但敲入后会形成剩余空头；若超过库存或销售计划，可能转为方向性风险。",
        },
        {
          name: "气囊累计2.0·实值收益",
          type: "调整每日收益起算价",
          badge: "入场优化",
          bestFor: "计划分批采购，希望从更低的收益起算价开始逐日取得采购补贴。",
          mechanism: "把未敲入执行价调整为实值，使标的只要高于该价格就按日产生线性收益；通常不设置上方封顶。",
          trigger: "下方障碍被触及时，仍按条款处理累计收益，并将剩余数量转为多头远期。",
          tradeoff: "更早取得收益需要用参与率、障碍距离、敲入建仓价或保证金条件交换，不能视为无成本增强。",
        },
        {
          name: "气囊累计2.0·敲入倍增",
          type: "提高敲入参与率",
          badge: "低位加仓",
          bestFor: "确有低位扩大采购的能力，希望平时逐日优化成本、深跌后按计划增加建仓数量。",
          mechanism: "未敲入时按约定参与率逐日结算；敲入参与率可高于未敲入参与率，用于放大剩余数量的低位建仓。",
          trigger: "触及下方障碍后，剩余观察天数对应的数量按更高参与率转为多头远期。",
          tradeoff: "倍增的是建仓义务和保证金需求；必须以真实采购能力限定总名义，不能用于无现货计划的抄底。",
        },
        {
          name: "气囊累计2.0·敲入建仓价优化",
          type: "调整敲入远期价格",
          badge: "参数优化",
          bestFor: "需要每日仓位管理，同时更重视敲入后远期建仓成本与现货预算的匹配。",
          mechanism: "未敲入执行价、障碍价和敲入后的远期建仓价可分别设置，用于平衡日常收益与敲入成本。",
          trigger: "障碍触发后，剩余数量按预先约定的敲入执行价转远期，而不是自动按障碍价成交。",
          tradeoff: "改善敲入建仓价通常会压低日常参与率、收窄保护区间或提高保证金，需整体询价比较。",
        },
      ],
    },
    {
