window.OIL_FUTURES_CONTRACTS = {
  "updated_at": "2026-08-31 11:36",
  "update_session": "midday",
  "timezone": "Asia/Shanghai",
  "source": "futures-oil-daily 最新快照：source_runs/2026-08-27-daily/raw/futures_market_data.json；国内合约名单先由 contract_selector_skill 选择，再由 contract_discovery_skill 按当月实时成交量、持仓量、成交额排序生成，海外产地盘展示马来 BMD FCPO 与印尼 ICDX CPOTR；内盘具体合约与日线缺口由 AkShare 补充，并用同花顺问财行情skill交叉验证；基本面沿用最近交易日晨报发布后冻结的快照，盘中、夜盘与凌晨尾盘仅刷新行情、技术面、驱动和资金",
  ...
  "market_references": {
    "malaysia_fcpo": {
      ...
      "change": "+0.35%",
      "unit": "林吉特/吨",
      "updated_at": "2026-08-26T22:59:59",
  ...
  "contracts": [
    {
      ...
      "view": "棕榈油当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏多，主要信号为价格在20日均线上方、均线多头排列、区间波动收敛，等待方向确认。基本面背景看棕榈油库存偏高但仅作背景压力；豆棕价差用于相对强弱背景；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅+1.25%；成交量较前快照+33.00%；持仓较前快照+4.39%。需要降级看待的地方：库存偏高但价格上涨，库存不能单独解释今日方向。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 137.29，说明观察位需要给盘中噪音留出空间。综合评分 61.80 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        "stance": "震荡",
        "entry": "现价 10171；区间内等待驱动与资金确认",
        "take_profit": "上方观察位 10370.53 / 下方观察位 9436.47",
        "stop_loss": "下方观察位 9436.47",
        "upper_watch": "10370.53",
        "lower_watch": "9436.47",
    ...
    },
    {
      ...
      "view": "棕榈油当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示数据不足，按中性处理，主要信号为技术数据不足。基本面背景看棕榈油库存偏高但仅作背景压力；豆棕价差用于相对强弱背景；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅+1.60%；成交量较前快照-74.00%；持仓较前快照-63.19%。需要降级看待的地方：库存偏高但价格上涨，库存不能单独解释今日方向。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 需进一步核验，说明观察位需要给盘中噪音留出空间。综合评分 50.80 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "豆油当前观点为偏多，置信度高。核心原因是：驱动与资金对价格更友好；技术面显示偏多，主要信号为价格在20日均线上方、均线多头排列、突破20日区间上沿。基本面背景看豆油库存压力，非24小时新增，只作背景；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅+1.55%；成交量较前快照+73.88%；持仓较前快照+8.45%。需要降级看待的地方：库存偏高但价格上涨，库存不能单独解释今日方向。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 106.36，说明观察位需要给盘中噪音留出空间。综合评分 62 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "豆油当前观点为分歧震荡，置信度低。核心原因是：各类信号并不一致，暂按分歧震荡处理；技术面显示数据不足，按中性处理，主要信号为技术数据不足。基本面背景看豆油库存压力，非24小时新增，只作背景；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅+1.96%；成交量较前快照-62.86%；持仓较前快照-65.25%。需要降级看待的地方：库存偏高但价格上涨，库存不能单独解释今日方向。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 需进一步核验，说明观察位需要给盘中噪音留出空间。综合评分 50.50 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "菜油当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏多，主要信号为价格在20日均线上方、均线结构震荡、区间波动收敛，等待方向确认。基本面背景看菜油库存压力但仅作背景压力；菜油基本面更多看油脂内部轮动；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅+0.35%；成交量较前快照+19.77%；持仓较前快照-4.34%。需要降级看待的地方：库存偏高但价格上涨，库存不能单独解释今日方向。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 156.79，说明观察位需要给盘中噪音留出空间。综合评分 54.20 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "菜油当前观点为分歧震荡，置信度低。核心原因是：各类信号并不一致，暂按分歧震荡处理；技术面显示偏多，主要信号为价格在20日均线上方、均线结构震荡。基本面背景看菜油库存压力但仅作背景压力；菜油基本面更多看油脂内部轮动；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅+0.72%；成交量较前快照-27.54%；持仓较前快照-13.66%。需要降级看待的地方：库存偏高但价格上涨，库存不能单独解释今日方向。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 146.50，说明观察位需要给盘中噪音留出空间。综合评分 51 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "豆粕当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏多，主要信号为价格在20日均线上方、均线多头排列、区间波动收敛，等待方向确认。基本面背景看基本面暂无强新增驱动；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅-0.45%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 43.71，说明观察位需要给盘中噪音留出空间。综合评分 57.20 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "豆粕当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示数据不足，按中性处理，主要信号为技术数据不足。基本面背景看基本面暂无强新增驱动；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅-0.26%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 需进一步核验，说明观察位需要给盘中噪音留出空间。综合评分 51 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "菜粕当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏多，主要信号为价格在20日均线上方、均线多头排列。基本面背景看基本面暂无强新增驱动；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅-0.38%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 37.71，说明观察位需要给盘中噪音留出空间。综合评分 57.20 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "菜粕当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏多，主要信号为价格在20日均线上方、均线多头排列、处于统计区间上沿外侧。基本面背景看基本面暂无强新增驱动；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅-0.46%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 31.07，说明观察位需要给盘中噪音留出空间。综合评分 57.10 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "view": "马棕油当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏多，主要信号为外盘参考合约，技术历史样本不足。基本面背景看外盘参考合约，国内基本面因子不直接套用；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅+0.35%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
          "text": "现价 4872 先看与 MA20 需进一步核验、MA60 需进一步核验 的相对位置，技术评分 需进一步核验，读数为数据需进一步核验。价格相对均线和区间位置偏强，但仍需要外盘驱动和资金配合确认延续性；主要信号是：外盘参考合约，技术历史样本不足。"
        },
        {
          "title": "关键区间",
          "text": "上方先观察20日区间上沿 需进一步核验 和统计通道上轨 需进一步核验，下方关注20日区间下沿 需进一步核验 和统计通道下轨 需进一步核验。这些位置用于判断突破或回落是否有效，不直接等同于开平仓点位。"
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 42，说明观察位需要给盘中噪音留出空间。综合评分 53 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        "stance": "震荡",
        "entry": "现价 4872；区间内等待驱动与资金确认",
        "take_profit": "上方观察位 4963.22 / 下方观察位 4780.78",
        "stop_loss": "下方观察位 4780.78",
        "upper_watch": "4963.22",
        "lower_watch": "4780.78",
        "invalidation": "若价格突破区间且驱动/资金同向，震荡判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
    ...
    },
    {
      ...
      "view": "印尼棕榈油当前观点为震荡，置信度中。核心原因是：当前行情缺少单边确认，仍需要等待新增驱动；技术面显示偏空，主要信号为外盘参考合约，技术历史样本不足。基本面背景看外盘参考合约，国内基本面因子不直接套用；驱动看FCPO+0.35%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+2.73%（24小时新增）；资金看当日涨跌幅-0.81%；成交量变化需进一步核验；持仓变化需进一步核验。需要降级看待的地方：暂未看到需要明显降级的冲突信号。",
      "technical_detail": [
        {
          "title": "价格位置",
        ...
        {
          "title": "波动节奏",
          "text": "14日平均波动幅度约 165.50，说明观察位需要给盘中噪音留出空间。综合评分 49.10 来自技术、基本面、驱动和资金共同作用，技术面只负责描述位置和节奏，不能单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
