  ...
  "contracts": [
    {
      ...
      "verification": "价格一致：AkShare 9302 / 行情skill 9302；涨跌幅口径不同：AkShare -0.41% / 行情skill -0.04%",
      "score": {
        "total": 55.1,
        "technical": 51.0,
        "fundamental": 50.0,
    ...
    },
    {
      ...
      "source": "AkShare + 同花顺问财行情skill",
      "note": "P 是棕榈油报告主线，重点看持仓与豆油、菜油共振。",
      "verification": "价格一致：AkShare 9571 / 行情skill 9571；涨跌幅口径不同：AkShare -0.35% / 行情skill -0.09%",
      "score": {
        "total": 56.4,
        "technical": 51.0,
        "fundamental": 50.0,
    ...
    },
    {
      ...
      "verification": "价格一致：AkShare 8572 / 行情skill 8572；涨跌幅口径不同：AkShare -0.17% / 行情skill +0.09%",
      "score": {
        "total": 62.2,
        "technical": 75.0,
        "fundamental": 50.0,
    ...
    },
    {
      ...
      "source": "AkShare + 同花顺问财行情skill",
      "note": "Y 用于观察豆系对棕榈油的共振或拖累。",
      "verification": "价格一致：AkShare 8539 / 行情skill 8539；涨跌幅口径不同：AkShare -0.23% / 行情skill +0.05%",
      "score": {
        "total": 64.1,
        "technical": 75.0,
        "fundamental": 50.0,
    ...
    },
    {
      ...
      "verification": "价格一致：AkShare 9868 / 行情skill 9868；涨跌幅口径不同：AkShare +0.10% / 行情skill +0.48%",
      "score": {
        "total": 60.8,
        "technical": 65.0,
        "fundamental": 50.0,
    ...
    },
    {
      ...
      "source": "AkShare + 同花顺问财行情skill",
      "note": "OI 用于观察油脂内部轮动和相对强弱切换。",
      "verification": "价格一致：AkShare 9854 / 行情skill 9854；涨跌幅口径不同：AkShare +0.11% / 行情skill +0.49%",
      "score": {
        "total": 58.8,
        "technical": 65.0,
        "fundamental": 50.0,
    ...
    },
    {
      ...
      "verification": "价格一致：AkShare 3032 / 行情skill 3032",
      "score": {
        "total": 62.7,
        "technical": 75.0,
        "fundamental": 50.0,
    ...
    },
    {
      ...
      "source": "AkShare + 同花顺问财行情skill",
      "note": "M 用于观察豆系蛋白粕与油脂之间的资金和压榨链条联动。",
      "verification": "价格一致：AkShare 3092 / 行情skill 3092；涨跌幅口径不同：AkShare -0.29% / 行情skill -0.03%",
      "score": {
        "total": 62.8,
        "technical": 75.0,
        "fundamental": 50.0,
