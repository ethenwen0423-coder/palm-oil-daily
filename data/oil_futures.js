window.OIL_FUTURES_CONTRACTS = {
  "updated_at": "2026-07-30 23:23",
  "update_session": "close",
  "timezone": "Asia/Shanghai",
  "source": "futures-oil-daily 最新快照：source_runs/2026-07-30-daily/raw/futures_market_data.json；国内合约名单先由 contract_selector_skill 选择，再由 contract_discovery_skill 按当月实时成交量、持仓量、成交额排序生成，海外产地盘展示马来 BMD FCPO 与印尼 ICDX CPOTR；内盘具体合约与日线缺口由 AkShare 补充，并用同花顺问财行情skill交叉验证；基本面沿用当日晨报发布后冻结的快照，午盘与收盘仅刷新行情、技术面、驱动和资金",
