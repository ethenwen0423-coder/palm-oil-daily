  ...
  "contracts": [
    {
      ...
      "verification": "价格一致：AkShare 9342 / 行情skill 9341；涨跌幅口径不同：AkShare +1.05% / 行情skill +1.54%",
      "score": {
        "total": 56.4,
        "technical": 51.0,
        "fundamental": 50.0,
      ...
      "strategy_recommendation": {
        "stance": "震荡偏强",
        "entry": "现价 9342；观察回撤后能否守住下方关键位",
        "take_profit": "上方观察位 9687.20",
        "stop_loss": "下方观察位 8943.11",
        "upper_watch": "9687.20",
        "lower_watch": "8943.11",
    ...
    },
    {
      ...
      "source": "AkShare + 同花顺问财行情skill",
      "note": "P 是棕榈油报告主线，重点看持仓与豆油、菜油共振。",
      "verification": "价格一致：AkShare 9608 / 行情skill 9606；涨跌幅口径不同：AkShare +0.95% / 行情skill +1.27%",
      "score": {
        "total": 53.2,
        "technical": 51.0,
        "fundamental": 50.0,
      ...
      "view": "棕榈油当前信号分歧，按震荡处理，总观点为分歧震荡，置信度低；技术面显示震荡（价格在20日均线上方、均线结构震荡）。基本面背景：棕榈油库存偏高，非24小时新增，只作背景；豆棕价差用于相对强弱背景。驱动：FCPO+0.04%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+0.15%（24小时新增）；WTI/Brent原油+0.79%（24小时新增）；天气出现24小时内可核验扰动；当日新增政策/新闻纳入驱动；周度库存不作为今日主驱动。资金：当日涨跌幅+0.95%；成交量较前快照-80.31%；持仓较前快照-56.52%；板块强弱排序 rapeseed_oil > palm_oil > soybean_oil；soybean_palm_spread变化 -1；rapeseed_soybean_spread变化 -4。冲突提示：库存偏高但价格上涨，库存不能单独解释今日方向。。",
      "technical_detail": [
        {
          "title": "趋势结构",
          "text": "现价 9608 对照 MA20 9567.90、MA60 9630.73，当前技术评分为 51，趋势标签为震荡。核心信号为：价格在20日均线上方、均线结构震荡。"
        },
        {
          "title": "支撑压力",
          "text": "20日价格区间上沿 9881、下沿 9313；统计通道上轨 9722.81、下轨 9412.99。这些位置决定突破确认和反抽压力。"
        },
        {
          "title": "波动与执行",
          "text": "14日平均波动幅度约 160.14，用于衡量波动区间和观察位有效性。综合评分 53.20 只作多因子结果，技术面不得单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        "stance": "分歧震荡",
        "entry": "现价 9608；区间内等待驱动与资金确认",
        "take_profit": "上方观察位 9955.83 / 下方观察位 9260.17",
        "stop_loss": "下方观察位 9260.17",
        "upper_watch": "9955.83",
        "lower_watch": "9260.17",
    ...
    },
    {
      ...
      "verification": "价格一致：AkShare 8588 / 行情skill 8588；涨跌幅口径不同：AkShare +0.92% / 行情skill +1.32%",
      "score": {
        "total": 58.9,
        "technical": 75.0,
        "fundamental": 47.0,
      ...
      "view": "豆油当前行情偏震荡，等待驱动确认，总观点为震荡，置信度中；技术面显示偏多（价格在20日均线上方、均线结构震荡、突破20日区间上沿）。基本面背景：豆油库存压力但仅作背景压力。驱动：FCPO+0.04%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+0.15%（24小时新增）；WTI/Brent原油+0.79%（24小时新增）；天气出现24小时内可核验扰动；当日新增政策/新闻纳入驱动；周度库存不作为今日主驱动。资金：当日涨跌幅+0.92%；成交量较前快照+3.67%；持仓较前快照+0.29%；板块强弱排序 rapeseed_oil > palm_oil > soybean_oil；soybean_palm_spread变化 -1；rapeseed_soybean_spread变化 -4。冲突提示：库存偏高但价格上涨，库存不能单独解释今日方向。。",
      "technical_detail": [
        {
          "title": "趋势结构",
          "text": "现价 8588 对照 MA20 8390.40、MA60 8480.08，当前技术评分为 75，趋势标签为偏多。核心信号为：价格在20日均线上方、均线结构震荡、突破20日区间上沿。"
        },
        {
          "title": "支撑压力",
          "text": "20日价格区间上沿 8505、下沿 8270；统计通道上轨 8514.89、下轨 8265.91。这些位置决定突破确认和反抽压力。"
        },
        {
          "title": "波动与执行",
          "text": "14日平均波动幅度约 88.29，用于衡量波动区间和观察位有效性。综合评分 58.90 只作多因子结果，技术面不得单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        "stance": "震荡",
        "entry": "现价 8588；区间内等待驱动与资金确认",
        "take_profit": "上方观察位 8629.66 / 下方观察位 8325.54",
        "stop_loss": "下方观察位 8325.54",
        "upper_watch": "8629.66",
        "lower_watch": "8325.54",
        "invalidation": "若价格突破区间且驱动/资金同向，震荡判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
    ...
    },
    {
      ...
      "source": "AkShare + 同花顺问财行情skill",
      "note": "Y 用于观察豆系对棕榈油的共振或拖累。",
      "verification": "价格一致：AkShare 8560 / 行情skill 8560；涨跌幅口径不同：AkShare +1.01% / 行情skill +1.36%",
      "score": {
        "total": 55.6,
        "technical": 75.0,
        "fundamental": 47.0,
      ...
      "view": "豆油当前信号分歧，按震荡处理，总观点为分歧震荡，置信度低；技术面显示偏多（价格在20日均线上方、均线结构震荡、突破20日区间上沿）。基本面背景：豆油库存压力但仅作背景压力。驱动：FCPO+0.04%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+0.15%（24小时新增）；WTI/Brent原油+0.79%（24小时新增）；天气出现24小时内可核验扰动；当日新增政策/新闻纳入驱动；周度库存不作为今日主驱动。资金：当日涨跌幅+1.01%；成交量较前快照-67.83%；持仓较前快照-43.99%；板块强弱排序 rapeseed_oil > palm_oil > soybean_oil；soybean_palm_spread变化 -1；rapeseed_soybean_spread变化 -4。冲突提示：库存偏高但价格上涨，库存不能单独解释今日方向。。",
      "technical_detail": [
        {
          "title": "趋势结构",
          "text": "现价 8560 对照 MA20 8355.50、MA60 8437.80，当前技术评分为 75，趋势标签为偏多。核心信号为：价格在20日均线上方、均线结构震荡、突破20日区间上沿。"
        },
        {
          "title": "支撑压力",
          "text": "20日价格区间上沿 8499、下沿 8237；统计通道上轨 8477.45、下轨 8233.55。这些位置决定突破确认和反抽压力。"
        },
        {
          "title": "波动与执行",
          "text": "14日平均波动幅度约 87.93，用于衡量波动区间和观察位有效性。综合评分 55.60 只作多因子结果，技术面不得单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        ...
        "take_profit": "上方观察位 8613.31 / 下方观察位 8298.81",
        "stop_loss": "下方观察位 8298.81",
        "upper_watch": "8613.31",
        "lower_watch": "8298.81",
        "invalidation": "若价格突破区间且驱动/资金同向，震荡判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
    ...
    },
    {
      ...
      "verification": "价格一致：AkShare 9871 / 行情skill 9872；涨跌幅口径不同：AkShare +1.33% / 行情skill +1.86%",
      "score": {
        "total": 59.8,
        "technical": 65.0,
        "fundamental": 50.0,
      ...
      "view": "菜油当前驱动与资金偏强，总观点为震荡偏强，置信度高；技术面显示偏多（价格在20日均线上方、均线结构震荡、区间波动收敛，等待方向确认）。基本面背景：菜油库存压力，非24小时新增，只作背景；菜油基本面更多看油脂内部轮动。驱动：FCPO+0.04%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+0.15%（24小时新增）；WTI/Brent原油+0.79%（24小时新增）；天气出现24小时内可核验扰动；当日新增政策/新闻纳入驱动；周度库存不作为今日主驱动。资金：当日涨跌幅+1.33%；成交量较前快照+3.33%；持仓较前快照+0.35%；板块强弱排序 rapeseed_oil > palm_oil > soybean_oil；soybean_palm_spread变化 -1；rapeseed_soybean_spread变化 -4。冲突提示：库存偏高但价格上涨，库存不能单独解释今日方向。。",
      "technical_detail": [
        {
          "title": "趋势结构",
          "text": "现价 9871 对照 MA20 9759.15、MA60 9729.22，当前技术评分为 65，趋势标签为偏多。核心信号为：价格在20日均线上方、均线结构震荡、区间波动收敛，等待方向确认。"
        },
        {
          "title": "支撑压力",
          "text": "20日价格区间上沿 10352、下沿 9453；统计通道上轨 10023.41、下轨 9494.89。这些位置决定突破确认和反抽压力。"
        },
        {
          "title": "波动与执行",
          "text": "14日平均波动幅度约 150.50，用于衡量波动区间和观察位有效性。综合评分 59.80 只作多因子结果，技术面不得单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        "stance": "震荡偏强",
        "entry": "现价 9871；观察回撤后能否守住下方关键位",
        "take_profit": "上方观察位 10197.89",
        "stop_loss": "下方观察位 9389.54",
        "upper_watch": "10197.89",
        "lower_watch": "9389.54",
        "invalidation": "若驱动评分与资金评分同步转弱，当前偏强判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
        "basis": "综合波动、突破、均线和区间测算观察位；共纳入 4 组候选点位，不输出明确交易指令。"
    ...
    },
    {
      ...
      "source": "AkShare + 同花顺问财行情skill",
      "note": "OI 用于观察油脂内部轮动和相对强弱切换。",
      "verification": "价格一致：AkShare 9859 / 行情skill 9857；涨跌幅口径不同：AkShare +1.36% / 行情skill +1.92%",
      "score": {
        "total": 56.5,
        "technical": 65.0,
        "fundamental": 50.0,
      ...
      "view": "菜油当前行情偏震荡，等待驱动确认，总观点为震荡，置信度中；技术面显示偏多（价格在20日均线上方、均线结构震荡、区间波动收敛，等待方向确认）。基本面背景：菜油库存压力，非24小时新增，只作背景；菜油基本面更多看油脂内部轮动。驱动：FCPO+0.04%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+0.15%（24小时新增）；WTI/Brent原油+0.79%（24小时新增）；天气出现24小时内可核验扰动；当日新增政策/新闻纳入驱动；周度库存不作为今日主驱动。资金：当日涨跌幅+1.36%；成交量较前快照-75.89%；持仓较前快照-41.36%；板块强弱排序 rapeseed_oil > palm_oil > soybean_oil；soybean_palm_spread变化 -1；rapeseed_soybean_spread变化 -4。冲突提示：库存偏高但价格上涨，库存不能单独解释今日方向。。",
      "technical_detail": [
        {
          "title": "趋势结构",
          "text": "现价 9859 对照 MA20 9758.35、MA60 9722.28，当前技术评分为 65，趋势标签为偏多。核心信号为：价格在20日均线上方、均线结构震荡、区间波动收敛，等待方向确认。"
        },
        {
          "title": "支撑压力",
          "text": "20日价格区间上沿 10364、下沿 9458；统计通道上轨 10032.35、下轨 9484.35。这些位置决定突破确认和反抽压力。"
        },
        {
          "title": "波动与执行",
          "text": "14日平均波动幅度约 148.93，用于衡量波动区间和观察位有效性。综合评分 56.50 只作多因子结果，技术面不得单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        "stance": "震荡",
        "entry": "现价 9859；区间内等待驱动与资金确认",
        "take_profit": "上方观察位 10182.47 / 下方观察位 9399.17",
        "stop_loss": "下方观察位 9399.17",
        "upper_watch": "10182.47",
        "lower_watch": "9399.17",
        "invalidation": "若价格突破区间且驱动/资金同向，震荡判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
        "basis": "综合波动、突破、均线和区间测算观察位；共纳入 4 组候选点位，不输出明确交易指令。"
    ...
    },
    {
      ...
      "verification": "价格一致：AkShare 3038 / 行情skill 3037；涨跌幅口径不同：AkShare +0.40% / 行情skill +1.10%",
      "score": {
        "total": 60.0,
        "technical": 75.0,
        "fundamental": 50.0,
      ...
      "technical_detail": [
        ...
        {
          "title": "波动与执行",
          "text": "14日平均波动幅度约 33.50，用于衡量波动区间和观察位有效性。综合评分 60 只作多因子结果，技术面不得单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
    ...
    },
    {
      ...
      "source": "AkShare + 同花顺问财行情skill",
      "note": "M 用于观察豆系蛋白粕与油脂之间的资金和压榨链条联动。",
      "verification": "价格一致：AkShare 3096 / 行情skill 3096；涨跌幅口径不同：AkShare +0.49% / 行情skill +1.04%",
      "score": {
        "total": 60.1,
        "technical": 75.0,
        "fundamental": 50.0,
      ...
      "view": "豆粕当前行情偏震荡，等待驱动确认，总观点为震荡，置信度中；技术面显示偏多（价格在20日均线上方、均线结构震荡、突破20日区间上沿）。基本面背景：基本面暂无强新增驱动。驱动：FCPO+0.04%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+0.15%（24小时新增）；WTI/Brent原油+0.79%（24小时新增）；天气出现24小时内可核验扰动；当日新增政策/新闻纳入驱动；周度库存不作为今日主驱动。资金：当日涨跌幅+0.49%；成交量变化需进一步核验；持仓变化需进一步核验；板块强弱排序 rapeseed_oil > palm_oil > soybean_oil；soybean_palm_spread变化 -1；rapeseed_soybean_spread变化 -4。冲突提示：暂无明显冲突信号。",
      "technical_detail": [
        {
          "title": "趋势结构",
          "text": "现价 3096 对照 MA20 3012.25、MA60 3033.13，当前技术评分为 75，趋势标签为偏多。核心信号为：价格在20日均线上方、均线结构震荡、突破20日区间上沿。"
        },
        {
          "title": "支撑压力",
          "text": "20日价格区间上沿 3047、下沿 2966；统计通道上轨 3061.10、下轨 2963.40。这些位置决定突破确认和反抽压力。"
        },
        {
          "title": "波动与执行",
          "text": "14日平均波动幅度约 29，用于衡量波动区间和观察位有效性。综合评分 60.10 只作多因子结果，技术面不得单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        "stance": "震荡",
        "entry": "现价 3096；区间内等待驱动与资金确认",
        "take_profit": "上方观察位 3098.80 / 下方观察位 2989.50",
        "stop_loss": "下方观察位 2989.50",
        "upper_watch": "3098.80",
        "lower_watch": "2989.50",
        "invalidation": "若价格突破区间且驱动/资金同向，震荡判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
    ...
    },
    {
      ...
      "view": "菜粕当前行情偏震荡，等待驱动确认，总观点为震荡，置信度中；技术面显示震荡（价格在20日均线上方、均线结构震荡）。基本面背景：基本面暂无强新增驱动。驱动：FCPO+0.04%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+0.15%（24小时新增）；WTI/Brent原油+0.79%（24小时新增）；天气出现24小时内可核验扰动；当日新增政策/新闻纳入驱动；周度库存不作为今日主驱动。资金：当日涨跌幅+0.56%；成交量变化需进一步核验；持仓变化需进一步核验；板块强弱排序 rapeseed_oil > palm_oil > soybean_oil；soybean_palm_spread变化 -1；rapeseed_soybean_spread变化 -4。冲突提示：暂无明显冲突信号。",
      "technical_detail": [
        {
          "title": "趋势结构",
          "text": "现价 2317 对照 MA20 2272.40、MA60 2322.37，当前技术评分为 51，趋势标签为震荡。核心信号为：价格在20日均线上方、均线结构震荡。"
        },
        {
          "title": "支撑压力",
          "text": "20日价格区间上沿 2321、下沿 2214；统计通道上轨 2322.13、下轨 2222.67。这些位置决定突破确认和反抽压力。"
        },
        {
          "title": "波动与执行",
          "text": "14日平均波动幅度约 39.29，用于衡量波动区间和观察位有效性。综合评分 54.10 只作多因子结果，技术面不得单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        ...
        "take_profit": "上方观察位 2344.60 / 下方观察位 2200.20",
        "stop_loss": "下方观察位 2200.20",
        "upper_watch": "2344.60",
        "lower_watch": "2200.20",
        "invalidation": "若价格突破区间且驱动/资金同向，震荡判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
    ...
    },
    {
      ...
      "view": "菜粕当前行情偏震荡，等待驱动确认，总观点为震荡，置信度中；技术面显示震荡（价格在20日均线上方、均线结构震荡、突破20日区间上沿）。基本面背景：基本面暂无强新增驱动。驱动：FCPO+0.04%（24小时新增）；CBOT豆油+0.51%（24小时新增）；美豆+0.15%（24小时新增）；WTI/Brent原油+0.79%（24小时新增）；天气出现24小时内可核验扰动；当日新增政策/新闻纳入驱动；周度库存不作为今日主驱动。资金：当日涨跌幅+0.67%；成交量变化需进一步核验；持仓变化需进一步核验；板块强弱排序 rapeseed_oil > palm_oil > soybean_oil；soybean_palm_spread变化 -1；rapeseed_soybean_spread变化 -4。冲突提示：暂无明显冲突信号。",
      "technical_detail": [
        {
          "title": "趋势结构",
          "text": "现价 2259 对照 MA20 2221.65、MA60 2276.82，当前技术评分为 64，趋势标签为震荡。核心信号为：价格在20日均线上方、均线结构震荡、突破20日区间上沿。"
        },
        {
          "title": "支撑压力",
          "text": "20日价格区间上沿 2252、下沿 2188；统计通道上轨 2253.19、下轨 2190.11。这些位置决定突破确认和反抽压力。"
        },
        {
          "title": "波动与执行",
          "text": "14日平均波动幅度约 27.57，用于衡量波动区间和观察位有效性。综合评分 57.50 只作多因子结果，技术面不得单独决定总观点。"
        }
      ],
      "fundamental_detail": [
        {
      ...
      "strategy_recommendation": {
        ...
        "take_profit": "上方观察位 2289.03 / 下方观察位 2202.65",
        "stop_loss": "下方观察位 2202.65",
        "upper_watch": "2289.03",
        "lower_watch": "2202.65",
        "invalidation": "若价格突破区间且驱动/资金同向，震荡判断失效。",
        "risk_tip": "仅给观察位和失效条件，不构成开平仓指令。",
