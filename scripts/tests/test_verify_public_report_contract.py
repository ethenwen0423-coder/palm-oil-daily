...
|OI|震荡|10000|资金确认|9900|10100|不新开仓|日内|""",
        ...
        "盘前市场全景": """|维度|已验证事实|对P/Y/OI影响|盘中验证信号|
|---|---|---|---|
|海外盘面|FCPO偏稳|P获支撑|外盘同向|
|美豆与豆油|CBOT油强粕弱|Y获支撑|油粕比|
|棕榈油产地|MPOB库存偏高|P上方受限|出口消化|
|菜籽链|ICE菜籽偏稳|OI跟随|内外联动|
|能源与生柴|原油回落|三油估值承压|原油止跌|
|国内现货与库存|仓单下降|P获近端支撑|基差改善|
|合约结构与资金|真实主次月|观察换月|主次同向|
|天气物流与政策|天气证据缺口|不计入方向|等待官方信息|""",
        "关键数据与价格": """|指标|数值|时点|含义|
|---|---|---|---|
...
|豆棕价差|-1000|前收盘|相对价值|
|菜豆油价差|1500|前收盘|相对价值|
|MPOB产量|180万吨|月度发布|官方供给|
|MPOB出口|140万吨|月度发布|官方需求|
|P国内注册仓单|430张|前收盘|国内实物|
|P关键位|9400|日内|失效边界|""",
        "价格预测与验证": """|品种|参考价|基准判断|下沿观察|上沿观察|上修触发|下修/失效|置信度|
|---|---|---|---|---|---|---|---|
|P|9500|震荡|9400|9600|站稳上沿|跌破下沿|★★☆☆☆|
|Y|8500|震荡|8400|8600|站稳上沿|跌破下沿|★★☆☆☆|
|OI|10000|震荡|9900|10100|站稳上沿|跌破下沿|★★☆☆☆|

以上价格预测由AI基于所列来源和既定模型生成，不代表任何来源方的官方立场，不构成投资建议，用户须自行核验。""",
