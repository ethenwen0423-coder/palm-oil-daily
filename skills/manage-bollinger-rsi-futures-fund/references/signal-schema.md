...
Required numeric fields for entries and pyramids are positive `reference_price`, `atr14`, `multiplier`, `margin_rate`, and non-negative `fee_rate`. `score` is the audited walk-forward allocation score, not an AI confidence. Exits do not require a score and always take precedence.
